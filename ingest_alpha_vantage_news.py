...
def test_alpha_vantage_news_api():
    ...
    logger.info(f"Probando Alpha Vantage News API con key: {ALPHA_VANTAGE_API_KEY[:10]}...")
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if 'feed' in data:
                    ...
                    for i, article in enumerate(articles[:3], 1):  # Mostrar solo las primeras 3
                        ...
                        logger.info(f"     Sentimiento: {sentiment_score} ({sentiment_label})")
