...
print(
    f"[{datetime.now()}] Iniciando ingesta de precios de los últimos 30 días para {len(STOCK_SYMBOLS)} símbolos..."
)
print(
    "⚠️  Nota: Alpha Vantage tiene un límite de 5 requests por minuto en el plan gratuito."
)
print(
    "   El script agregará delays de 12 segundos entre cada símbolo para respetar el límite.\n"
)
